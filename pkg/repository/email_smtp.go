...
func (r *EmailSmtpPostgres) SendConfirmEmailMessage(email, code string) error {
	baseText := "Hello!. Please, confirm your email with this code: %s. If you don't ask this code just ignore this message. This message is autogenerated. Please don't answer."
