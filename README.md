...
|Статус код|Причины|Тело ответа|
|-|--------|------|
|200|Все хорошо|[{"first_name": string, "second_name":string, "profile_picture_url": string}], длина массива не более 50|
|400|Некорректный json|{"message": string}|
***
...
|Статус код|Причины|Тело ответа|
|-|--------|------|
|200|Все хорошо|{friends:[{fullname: string, username: string, profile_pic: string}]}|
|400|Некорректные данные|{"message": string}|
***
...
|Статус код|Причины|Тело ответа|
|-|--------|------|
|200|Все хорошо|{follows:[{fullname: string, username: string, profile_pic: string}]}|
|400|Некорректные данные|{"message": string}|
***
...
|Статус код|Причины|Тело ответа|
|-|--------|------|
|200|Все хорошо|{subs:[{fullname: string, username: string, profile_pic: string}]}|
|400|Некорректные данные|{"message": string}|
***
